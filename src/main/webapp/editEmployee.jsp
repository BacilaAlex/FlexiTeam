    ...
    <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/EditEmployee">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input name="monthly_salary" type="text" class="form-control" id="monthly_salary" required
                       placeholder="${employee.monthlySalary}"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input name="religion" type="text" class="form-control" id="religion" required
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input name="bank_account" type="text" class="form-control" id="bank_account" required
